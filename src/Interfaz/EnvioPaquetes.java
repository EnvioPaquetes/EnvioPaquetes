...
public class EnvioPaquetes extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cargo = new javax.swing.JTextPane();
        jButton7 = new javax.swing.JButton();
        jButton8 = new javax.swing.JButton();
        jLabel26 = new javax.swing.JLabel();
        jScrollPane31 = new javax.swing.JScrollPane();
        experiencia = new javax.swing.JTextPane();
        ...
        jScrollPane24.setViewportView(cedula);

        jLabel20.setText("NOMBRE");

        jScrollPane25.setViewportView(nombre);

        jLabel21.setText("APELLIDO");

        jScrollPane26.setViewportView(apellido);

        jLabel22.setText("TELEFONO");

        jScrollPane27.setViewportView(telefono);
        ...
        jScrollPane28.setViewportView(direccion);

        jScrollPane29.setViewportView(email);

        jScrollPane30.setViewportView(cargo);
        ...
        jScrollPane31.setViewportView(experiencia);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        try {
            ...
            String ce,no,ap,te,di,em,car,ex;
            int tel,cel;
            String sql="";
            ce = cedula.getText();
            cel = Integer.parseInt(ce);
            no = nombre.getText();
            ap = apellido.getText();
            te = telefono.getText();
            ...
            em = email.getText();
            car = cargo.getText();
            ex = experiencia.getText();
            sql="INSERT INTO empleados (cedula,nombre,apellido,telefono,dirección,email,cargo,experiencia) VALUES (?,?,?,?,?,?,?,?)";
            ...
            cn.close();
            if (nu>0){
                JOptionPane.showMessageDialog(null,"Su registro ha sido nguardado");
            }
        } catch (SQLException ex1) {
            Logger.getLogger(EnvioPaquetes.class.getName()).log(Level.SEVERE, null, ex1);
        }
